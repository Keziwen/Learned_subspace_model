...
import os
from model import SPNet, SPNet_fixed, DCCNN, ADMMNet, PDNet, ISTANet, PDSPNet, DCCNNSP
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mask_pattern', metavar='str', nargs=1, default=['1Dgauss'], help='mask pattern: cartesian, radial, spiral, vista, gauss')
    parser.add_argument('--net', metavar='str', nargs=1, default=['SP_Net_fixed'], help='SP_Net, DCCNN, PDNet, ADMMNet')
    parser.add_argument('--gpu', metavar='int', nargs=1, default=['1'], help='GPU No.')
    parser.add_argument('--data', metavar='str', nargs=1, default=['dHCP_2D'], help='dataset name: dHCP_2D, ours_CH_2D, ours_UH_2D, ours_FH_2D, ours_NS_2D')
    parser.add_argument('--num_trainData', metavar='int', nargs=1, default=['700'], help='number of training data')
    parser.add_argument('--condition', metavar='str', nargs=1, default=['None'], help='None, noise, inhomogeneity')
    ...
    weight_file = 'models/stable/'+net_name+'_iter_'+str(niter)+'_acc_'+str(acc_train)+'.0_'+mask_pattern_train+'_dHCP_2D_NumData_'+str(num_trainData)+'/epoch-140/ckpt'
